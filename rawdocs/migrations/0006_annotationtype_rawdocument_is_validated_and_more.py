    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(help_text="Nom affiché dans l'interface", max_length=100)),
                ('color', models.CharField(default='#3b82f6', help_text="Couleur hex pour l'annotation", max_length=7)),
        ...
        migrations.AddField(
            ...
            name='is_validated',
            field=models.BooleanField(default=False, help_text='Document validé par un métadonneur'),
        ),
        migrations.AddField(
            model_name='rawdocument',
            name='pages_extracted',
            field=models.BooleanField(default=False, help_text='Pages extraites individuellement'),
        ),
        migrations.AddField(
            model_name='rawdocument',
            name='total_pages',
